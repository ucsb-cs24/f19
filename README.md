...
Jekyll-based website for UCSB CS24 Fall 2019, for shared course materials.

* website: <https://ucsb-cs24.github.io/f19/>
...
Build Status: [![Build Status](https://travis-ci.org/ucsb-cs24/f19.svg?branch=master)](https://travis-ci.org/ucsb-cs24/f19)
...
The site for this repo is:  <https://travis-ci.org/ucsb-cs24/f19>

* At that site you can enable builds (if the logo shows grey for no info), or see a log of the latest build.
* Also, see the green dots, yellow dots, and red x's on the [Commit log of this repo](https://github.com/ucsb-cs24/f19/commits/master)
