...
assigned: 2019-10-17 00:00:00.00-8
due: 2019-10-29 23:59:00.00-8
---
...
```
cp ~/cs24/cs24-f19-starter-code/{{page.num}}/* ~/cs24/{{page.num}}/
```
...
Starting program: /cs/faculty/dimirza/git/cs24-f19-starter-code/lab02/buggy CS16 A CS24 A+ CS32 A
